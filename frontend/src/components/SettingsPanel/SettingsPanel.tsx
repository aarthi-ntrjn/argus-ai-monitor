...
export function SettingsPanel({ settings, onToggle, onOpenAllSettings }: SettingsPanelProps) {
  ...
  return (
    <div className="absolute right-0 top-full mt-1 w-96 bg-white border border-gray-200 rounded-lg shadow-lg z-50 px-5 py-3 max-h-[calc(100vh-4rem)] overflow-y-auto">
