...
- [x] T035 Update root `README.md`: add "Landing Page" entry under a new "Links" or "Resources" section with the GitHub Pages URL (`https://aarthi-ntrjn.github.io/argus`)
